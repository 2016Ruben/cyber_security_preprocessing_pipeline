...
{ time python main.py ${pcapf} ${yaml_input} --input_type=kitsune --labelf_path=${labelf} --b_size=${b_size} --save_scaler=0 --figure_path=${figure_file} --model_save_path=${model_file} --results_dict_save_path=${res_file} --b_size=8 --n_training_examples=1000000 ; } 2> ${time_file}